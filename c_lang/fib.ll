...
@.str = private unnamed_addr constant [13 x i8] c"fib(%d) %d \0A\00", align 1
...
define i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32 %3, i32 %5)
  ret i32 0
}
